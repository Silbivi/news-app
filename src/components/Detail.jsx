                        ...
                        {news.slice(24,28).map((highlight) => {
                            return(
                                <div className="flex flex-col mb-10">
                                    <Link to={`/anotherdetail/${highlight.id}`}> <h1 className="font-bold hover:text-blue-900">{highlight.title}</h1> </Link>
                    ...
                    return(
                        <div className="flex flex-row md:flex-col md:w-56 mb-5 md:mb-0">
                            <img 
                                ...
                                />
                            <Link to={`/anotherdetail/${bigHightlight.id}`}> <h1 className="md:mt-3 font-bold text-sm md:text-base hover:text-blue-900">{bigHightlight.title}</h1> </Link>
                        </div>
                    )
                })}
            </div>
